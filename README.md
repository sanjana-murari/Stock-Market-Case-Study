This project focuses on analyzing stock price trends for major tech companies — Apple (AAPL), Amazon (AMZN), Google (GOOG), and Microsoft (MSFT) — using historical data.
